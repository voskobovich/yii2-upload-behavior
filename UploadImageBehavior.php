 ...
 *     return [
 *         [
 *             'class' => \voskobovich\behaviors\UploadImageBehavior::className(),
 *             'attribute' => 'file',
...
class UploadImageBehavior extends UploadBehavior
{
     ...
     */
    public function getFileUrl($attribute, $profile = false)
    {
        if (!$profile) {
            /** @var BaseActiveRecord $model */
            $model = $this->owner;
